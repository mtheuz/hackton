        ...
        >
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="min-h-11 rounded-lg border border-line-200 bg-canvas px-3.5 py-2.5 text-sm text-ink-900 outline-none transition-all duration-200 focus:border-brand-600 focus:bg-surface focus:ring-2 focus:ring-brand-600/20"
            />
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <input
                ...
                className="min-h-11 w-full rounded-lg border border-line-200 bg-canvas px-3.5 py-2.5 pr-11 text-sm text-ink-900 outline-none transition-all duration-200 focus:border-brand-600 focus:bg-surface focus:ring-2 focus:ring-brand-600/20"
              />
              <button
                type="button"
